...
:: Command = CExp [CExp] | CAssing Int | CAssingl Int  // CAssing global and CAssingl local, same as read and readl.
	...
	| CFCall Id Int | CReturn | CReturne
	...
	| BranchMatch [(Int, Id)] Id // Int is the count number of the algebraic type and Id the label to jump at.
:: CExp = Read Int	// Read a global var and put it on the stack.
	...
	| EFCall Id Int	// Call function Id. Drop Int params afterwards. We add a function to generate Tupels and Lists.
